        ...
        .then((response) => {
            ...
            <div class="card shadow" style="margin-bottom: 30px;">
                <div class="info d-flex justify-content-between"
                    ...
                    <div id="info_div" onclick="info_divClicked(${post.author.id})">
                    ...
                    ${id == post.author.id ? `<span class="twoButtons" style="margin-right: 10px;">
                ...
                <div id="comments" onclick="ClickedPost('${encodeURIComponent(JSON.stringify(post))}')" style="padding: 17px; cursor:pointer;">
